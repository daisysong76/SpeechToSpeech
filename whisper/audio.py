# ERROR:root:Failed to process audio 3: encode() missing 2 required positional arguments: 'input_audio_lengths' and 'audio_span_tokens'
# ERROR:root:Type of audio: <class 'str'>
...
# Encodes audio inputs using convolutional layers, positional embeddings, and a series of residual attention blocks.
# Forward Method: Processes the input tensor through convolutional layers, applies positional embeddings, and passes it through attention blocks.
# encode Method: Prepares input audio data, generates padding masks, and encodes the audio sequences into embeddings suitable for further processing in a neural network.
